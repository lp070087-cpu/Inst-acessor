...
exports.PLAN_CATALOG = [
    {
        ...
        durationDays: 7,
        description: "Acesso por 7 dias. Pagamento único, sem renovação automática.",
        features: [
            "Instagram",
            "TikTok",
            "Dashboard",
    ...
    },
    {
        ...
        durationDays: 30,
        description: "Assinatura mensal recorrente. Acesso contínuo enquanto estiver ativa.",
        features: [
            "Instagram",
            "TikTok",
            "Dashboard",
    ...
    },
    {
        ...
        durationDays: 365,
        description: "Assinatura anual. Equivalente aproximado de R$ 45,58/mês — a melhor relação custo-benefício.",
        features: [
            "Instagram",
            "TikTok",
            "Dashboard",
