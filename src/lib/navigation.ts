...
export const mainNav: NavItem[] = [
  ...
  },
  {
    ...
    href: "/calendario",
    icon: CalendarDays,
    description: "Planejamento e pipeline de conteúdo",
  },
  {
    label: "Central de Publicação",
    href: "/publishing",
    icon: Send,
    description: "Fila, status e re-tentativas de publicação",
  },
  {
    label: "Automações Inteligentes",
    href: "/growth",
    icon: Zap,
    description: "Motor operacional de crescimento",
  },
  {
    label: "Mentoria",
    href: "/mentoria",
  ...
  },
  {
    ...
    href: "/automacoes",
    icon: Zap,
    description: "Regras de resposta — nenhuma mensagem é enviada automaticamente",
  },
  {
    label: "Redes Sociais",
    href: "/redes-sociais",
