 ...
 */
async function generateAlerts(userId, platform) {
...
function makeAlert(code, platform, severity, value, reference) {
    const rule = (0, registry_1.getRuleBySlug)(code === "ALCANCE_CAIU" || code === "ALCANCE_AUMENTOU" ? "alertas-oficiais" : "alertas-oficiais");
    const label = code === "ALCANCE_CAIU"
        ? "Alcance caiu"
